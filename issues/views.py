...
def getUrl(request):
    ...
    if r.status_code == 200:
        ...
        params = {'total': total_issues, 'count': count, 'count2': count2, 'total_greater_than_7days': total_issues_greater_than_7days, 'dict_of_url_and_title': dict_of_url_and_title}
